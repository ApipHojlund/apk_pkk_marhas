...
<body>
    <div class="border">
        <div class="header">
            <center><img src="{{asset('assets/images/logo_MMart.png')}}" width="170" height="170" alt=""></center>
            ...
            <form action="/postLogin" method="post">
                ...
                <div class="mb-3">
                    <input
                        ...
                        <br>
                    <small id="helpId" class="form-text text-muted">insert your username*</small>
                </div>
                <br>
                <div class="mb-3">
                    <input
        ...
        <div class="footer">
            <center>
                <div class="tombol">
                    ...
                    <a class="tombol-dalem" href="/register">Register</a>
                </div>
            </center>
        </div>
    </div>
